...
2. "Надел одежду" / "Посмотрел" / "Спросил" -> satiety: 0, energy: 0. (НЕ МЕНЯТЬ!)
3. satiety (Сытость): 100=сыт, 0=голод. Еда дает +satiety.
4. energy (Бодрость): 100=бодр, <35=устал. Сон дает +energy.
5. timeChange АВТОМАТИЧЕСКИ их снижает. НЕ снижай их вручную в JSON, если игрок не делает ничего утомительного (бой/бег).
