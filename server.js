...
3. ЗАПРЕТ HTML: Никогда не используй HTML-теги (типа <p>, <span>, class=...) в поле "description". Пиши только чистый текст.
4. ПРЯМАЯ РЕЧЬ: Всегда выделяй кавычками «» или "". Сервер сам подсветит её.
