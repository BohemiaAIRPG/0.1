        ...
        if (allEffects.length > 0) {
            ...
            htmlContent += `
                <div style="margin-bottom: 14px;">
                    <div style="color:#888; font-size:0.8em; margin-bottom:5px; text-transform:uppercase; letter-spacing:1px;">Последствия хода</div>
...
function getItemIcon(name) {
    ...
    if (lower.includes('сапог') || lower.includes('обувь')) return '👢';
    if (lower.includes('перчат')) return '🧤';
    if (lower.includes('плащ') || lower.includes('обмотки') || lower.includes('тряпк') || lower.includes('лохмотья') || lower.includes('рубаха') || lower.includes('штаны')) return '🧥';
